...
// it sorts the columns of dependent one by the values in the basic one - number of values in basic should be equal to the number of cols in dependent; descending order
{
